...
function Row(props) {
    ...
    return (
        ...
        <TableCell align="right">{row.protein}</TableCell> */}
            ...
            {users.map(({ title, description, modedemploi, companyDescription, responsabilities, requiredSkills, expYears, recommandations, status }, index) => (
                <TableRow key={index} sx={{ '& > *': { borderBottom: 'unset' } }}>
                    ...
                    <TableCell align="left">{recommandations[1]}</TableCell>
                    ...
                    <Collapse in={open} timeout="auto" unmountOnExit>
                        <Box sx={{ margin: 1 }}>
                            ...
                            <Table size="small" aria-label="purchases">
                                ...
                                <TableBody>
                                    {users.map((recommandations, index) => (
                                        <TableRow key={index}>
                                            <TableCell component="th" scope="row">
                                                {recommandations[0]}
                                            </TableCell>
                                            <TableCell>{recommandations[1]}</TableCell>
